...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide">
				...
				<div class="wp-block-cover__inner-container">
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button is-style-fill">
							<a class="wp-block-button__link has-base-color has-text-color has-link-color wp-element-button" href="#"><?php echo esc_html__( 'Read More', 'olivaint' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
		...
		<div class="wp-block-column" style="flex-basis:67.09062%">
			...
			<div class="wp-block-group has-base-color has-primary-background-color has-text-color has-background has-link-color" style="border-radius:28px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
				...
				<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'Arrange a Personal Visit', 'olivaint' ); ?></h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"layout":{"selfStretch":"fit","flexSize":null}}} -->
				<p><?php echo esc_html__( 'Experience Kentwood Academy firsthand. Tailored to your child’s interests and admission stage, we offer visits year-round, from Nursery to Prep School.', 'olivaint' ); ?></p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button is-style-outline">
						<a class="wp-block-button__link has-base-color has-text-color has-link-color has-border-color has-base-border-color wp-element-button" style="border-width:2px"><?php echo esc_html__( 'Arrange a Visit', 'olivaint' ); ?></a>
					</div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<div class="wp-block-group has-primary-background-color has-background" style="border-radius:28px;min-height:100%">
						...
						<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo-white.png" alt="<?php echo esc_attr_e( 'Logo of the school made up with a shield and a lion.', 'olivaint' ); ?>"/></figure>
						<!-- /wp:image -->
					</div>
					<!-- /wp:group -->
				</div>
				...
				<div class="wp-block-column">
					...
					<div class="wp-block-group has-primary-color has-tertiary-background-color has-text-color has-background" style="border-radius:28px;min-height:100%;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
						<!-- wp:heading {"fontSize":"x-large"} -->
						<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'Admissions', 'olivaint' ); ?></h2>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"fontSize":"small"} -->
						<p class="has-small-font-size"><?php echo esc_html__( 'Selecting the ideal educational environment for your child is a significant and profound choice.', 'olivaint' ); ?></p>
						<!-- /wp:paragraph -->
						...
						<div class="wp-block-buttons">
							...
							<div class="wp-block-button is-style-fill">
								<a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Read More', 'olivaint' ); ?></a>
							</div>
							<!-- /wp:button -->
						</div>
						<!-- /wp:buttons -->
	...
	<div class="wp-block-columns alignwide">
		...
		<!-- wp:column {"width":"32.90938%"} -->
		<div class="wp-block-column" style="flex-basis:32.90938%">
			<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/example.webp","dimRatio":0,"minHeight":100,"minHeightUnit":"%","isDark":false,"style":{"layout":{"selfStretch":"fill","flexSize":null},"border":{"radius":"28px"}}} -->
			<div class="wp-block-cover is-light" style="border-radius:28px;min-height:100%"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="<?php echo esc_attr_e( 'Smiling small children waving their hands.', 'olivaint' ); ?>" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/example.webp" data-object-fit="cover"/>
				<div class="wp-block-cover__inner-container">
